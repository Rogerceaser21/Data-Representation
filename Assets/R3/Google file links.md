...
| Tab | Purpose |
|---|---|
| `OTP Submissions` | All OTP submissions (38 columns since otp-v0.9, append-only; `record_token` is 25th, `evidence_pad_id` 26th, `time_out` 34th, `status` 35th, `closed_at` 36th, `lap` 37th, `round` 38th) |
