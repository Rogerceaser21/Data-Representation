# Graph Report - wt-v093-ship  (2026-09-12)

## Corpus Check
- 132 files · ~1,188,169 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2084 nodes · 3422 edges · 185 communities (150 shown, 35 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 99 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7438dfc6`
...
Cohesion: 0.07
Nodes (6): _endDragAfter(), _endDragBefore(), get(), isValidSelector(), _prepareToStringify(), q
...
Cohesion: 0.18
Nodes (10): Claim-by-claim map, Compare, Flags (real number shown; nothing rewritten), Headline verdict, Live numbers (now), Phase A . Congruence audit + reference map (Snapshot claims vs live R3 data), Primary & Kindy . What is working, Primary & Kindy . Where to focus next (+2 more)
...
Cohesion: 0.12
Nodes (16): AIS Assessment Dashboard · Architecture Decision Record, Locked decisions (the grill), Q10 · Sequencing & the fate of Jobs 1-3, Q11 · Build order to Tuesday, Q1 · Product shape — separate app, deck design language, Q2 · Storage migration — dual-write bridge, Q3 · Auth — Google SSO, multi-provider-capable, RLS, Q4 · Access model — immutable evidence, attributed annotations (+8 more)
...
Cohesion: 0.07
Nodes (7): $(), backCompat(), each(), ei(), getRGB(), _hexToRgb(), ti()

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (26): BASE_DIR, buildEnv(), eqJson(), EXPECTED_OTP_COLUMNS, FIXED_MS, GS_DIR, GS_FILES, HERE (+18 more)
...
Cohesion: 0.18
Nodes (3): createCanvasElement(), we, ze()

### Community 57 - "Community 57"
Cohesion: 0.20
Nodes (5): addComponentsGetterSetter(), cloneObject(), _getProjectionToLine(), _getProjectionToSegment(), _prepareArrayForTween()
...
Cohesion: 0.22
Nodes (8): 0. What Igor rejected in v0.6 (measured on the live form, 1280 / 1180x820 / 820x1180), 1. Rubric wrapper: no scrollbars, 2. The `+` note button, 3. The pop-up (`.rub-note-pop`) and scrim (`.rub-note-scrim`), 4. Calm palette (chips, legend, record view, print), 5. Tests · `Assets/OTP/tests/otp.spec.ts` (build first: `bash Assets/OTP/encrypt.sh`), 6. Out of scope, otp-v0.7 contract · anchored note pop-up, + button geometry, calm palette, no scrollbars
...
Cohesion: 0.22
Nodes (8): Backend contract, Build, Changelog, otp-v0.9.2 (2026-09-11, evening), otp-v0.9.3 (2026-09-12), Progress in Lessons OTP form · otp-v0.9.1, Tests, What is on the page
...
Cohesion: 0.20
Nodes (9): 1. Scope, 2. Payload (POST JSON, `form:"otp"`) · exactly these 31 keys, 3. Value formats, 4. Wording (exact, outward-facing, approved), 5. Form (lane A) · `Assets/OTP/src/otp-progress-form.html`, 6. Backend (lane B) · `Assets/R3/apps-script/`, 7. Tests (lane A) · `Assets/OTP/tests/otp.spec.ts`, 8. Shared-worktree rule (both lanes, read twice) (+1 more)
...
## Knowledge Gaps
- **845 isolated node(s):** `generated`, `certificate`, `round_example`, `prompts`, `generated` (+840 more)
